...
CONFIG_PATH="/u/dvoss/al_pmssmwithgp/Run3ModelGen/source/Run3ModelGen/data/start_config4D.yaml"
SCAN_DIRECTORY="/u/dvoss/al_pmssmwithgp/Run3ModelGen/source/Run3ModelGen/scans/scan_start4D"
