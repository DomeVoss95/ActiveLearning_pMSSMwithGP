...
if __name__ == "__main__":
    ...
    mean = observed_pred.mean.numpy()
    model.plot_heatmap(x_test, mean, 'Mean log(Omega/0.12)', 'Gaussian Process Mean Heatmap', "mean_heatmap1.png")
    ...
    model.plot_heatmap(x_test, z.numpy(), 'log(Omega/0.12)', 'True Function Heatmap', "true_function_heatmap1.png")
    
    model.plot_entropy(x_test, entropy.numpy(), "entropy_heatmap.png")
    
    model.highlight_top_entropy_points(x_test, entropy, observed_pred, "highlight_top_entropy_points1.png")
