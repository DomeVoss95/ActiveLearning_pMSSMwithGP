...
class MultitaskGP2D(gpytorch.models.ExactGP):
    ...
    def __init__(self, x_train, y_train, x_valid, y_valid, likelihood, n): 
        ...
        self.covar_module = gpytorch.kernels.RBFKernel() # The kernel needs so be adjusted for higher dimensions
